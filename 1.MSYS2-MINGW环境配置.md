...
打开 前面选的环境的 mirrorlist （这里我们以mirrorlist.ucrt64 为例）,但是最好配了一个就将其余几个版本都配一下以防万一
> 另外 我已经将我的配置文件全都放在了 [这里](./mirrors)
...
## China - BFSU
Server = https://mirrors.bfsu.edu.cn/msys2/mingw/mingw32/
...
## China - BFSU
Server = https://mirrors.bfsu.edu.cn/msys2/mingw/mingw64/
